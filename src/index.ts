...
const OUTPUT_PATH = './retimed_sub.srt'; // Where to save the retimed SRT file
...
const SPLITTED_SUBTITLE: string[] = SUBTITLE.split(WHOLE_SEPARATOR); // the WHOLE SRT splitted
...
for (const RAW_SPLITTED of SPLITTED_SUBTITLE) {
    ...
    fs.writeFileSync(OUTPUT_PATH, new_srt); // It's fone :D
}